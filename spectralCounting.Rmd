...
writeLines(c(getwd(), ls(), params$sdrfInput, params$mzTabInput), fileConn)
close(fileConn)
```
...
sdrf <- read.delim(params$sdrfInput, stringsAsFactors = FALSE)
```
...
MzTabRes <- MzTab(params$mzTabInput)
